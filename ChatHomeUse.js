...
const ChatHomeUse = (props) => {
    const [chatTops, setChatTops] = useState([
        //  サンプル
        { iconimage: require('./assets/image/icon.png'), name: 'まちこ', message: '頑張りましょう！', date: '2022/11/01', time: '12:01', bell: 1 },
        { iconimage: require('./assets/image/icon.png'), name: 'まちた', message: 'うおおおおおおおおおおおおおおおおおおおおおお', date: '2022/12/1', time: '12:01', bell: 1 },
        { iconimage: require('./assets/image/icon.png'), name: 'まち助', message: 'うおおおおおおおおおおおおおおおおおおおおおお', date: '2022/12/1', time: '12:01', bell: 0 },
        { iconimage: require('./assets/image/icon.png'), name: 'まちお', message: 'うおおおおおおおおおおおおおおおおおおおおおお', date: '2022/12/1', time: '12:01', bell: 0 },
        ...
        <View style={styles.body}>
            ...
            <ScrollView style={{ flex: 1 }}>
                {chatTops.map((chatTop, index) => (
                    <TouchableOpacity key={index} onPress={() => props.navigation.navigate('ChatScreenUse', { data: chatTop.name })} >
